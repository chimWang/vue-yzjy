<template>
  <div class="open-course">
    <div class="bind" v-if="isLogin===1">
      <not-logged :warning="warning" :buttonText="buttonText"
                  :notBind="notBind" :otherText="otherText"></not-logged>
    </div>
    <scroll class="open-course-scroll" v-if="isLogin===2">
      ...
      <div>
        <ul class="course" v-for="(item, index) in course" :key=index>
          <li @click="intoCourse(index)" v-if="item.isPublic===false">
